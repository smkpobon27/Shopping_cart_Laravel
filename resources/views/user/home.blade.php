    ...
    <section class="ftco-section">
        <div class="container">
                    ...
                    <div class="col-md-3 d-flex">
                        <div class="product ftco-animate">
                            <div class="img d-flex align-items-center justify-content-center"
                                style="background-image: url({{ asset(Storage::disk('local')->url($products[$i]['image'])) }});">
                                <div class="desc">
                                    <p class="meta-prod d-flex">
                                        <a href="/product/add-to-cart/{{ $products[$i]['id'] }}"
                                            class="d-flex align-items-center justify-content-center"><span
                                                class="flaticon-shopping-bag"></span></a>
                                        <a href="#" class="d-flex align-items-center justify-content-center"><span
                                                class="flaticon-heart"></span></a>
                                        <a href="/product/single/{{ $products[$i]['id'] }}"
                                            class="d-flex align-items-center justify-content-center"><span
                            ...
                            <div class="text text-center">
                                ...
                                <p class="mb-0"> <span class="price">${{ $products[$i]['price'] }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <a href="/products" class="btn btn-primary d-block">View All Products <span
